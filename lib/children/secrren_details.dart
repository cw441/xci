...
class  screenIn3412 extends StatefulWidget {
  String id;
  ...
  @override
  State<screenIn3412> createState() => _screenIn3412State(id,name,desc,conutry,prase,expar,sizeproduct,numberproduct,image);
}

class _screenIn3412State extends State<screenIn3412> {
  String id;
                                  ...
                                  SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                                   Row(
                                    ...
                                    Container(
                                      ...
                                      child: coomwes(
                                          iad:id,
                                          apidata:'https://sddkakn.onrender.com/user1/comnetuserg1/${id}'
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: pcs(
                                          iad:id,
                                          apip:"https://sddkakn.onrender.com/user1/comnetuserp1"
                                      ),
                                    )
                                  ]
                       )
