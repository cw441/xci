...
class  xcxcb extends StatefulWidget {
  String id;
  ...
  @override
  State<xcxcb> createState() => _xcxcbState(id,name,desc,conutry,prase,expar,sizeproduct,numberproduct,image);
}

class _xcxcbState extends State<xcxcb> {
  String id;
                                  ...
                                  SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                                   Row(
                                    ...
                                    Container(
                                      ...
                                      child: coomwes(
                                          iad:id,
                                          apidata:'https://sddkakn.onrender.com/user1/comnetuserg8/${id}'
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: pcs(
                                          iad:id,
                                          apip:"https://sddkakn.onrender.com/user1/comnetuserp8"
                                      ),
                                    )
                                  ]
                       )
