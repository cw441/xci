...
class  screenIn344 extends StatefulWidget {
  String id;
  ...
  @override
  State<screenIn344> createState() => _screenIn344State(id,name,desc,conutry,prase,expar,sizeproduct,numberproduct,image);
}

class _screenIn344State extends State<screenIn344> {
  String id;
                                  ...
                                  SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                                   Row(
                                    ...
                                    Container(
                                      ...
                                      child: coomwes(
                                          iad:id,
                                          apidata:'https://sddkakn.onrender.com/user1/comnetuserg3/${id}'
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: pcs(
                                          iad:id,
                                          apip:"https://sddkakn.onrender.com/user1/comnetuserp3"
                                      ),
                                    )
                                  ]
                       )
