...
import 'getdata.dart';
class retan extends StatefulWidget {
  const retan({Key? key}) : super(key: key);

  @override
  State<retan> createState() => _retanState();
}

class _retanState extends State<retan> {
  ...
  Future<List<PostSd>> deleteAlbum( id) async {
    final http.Response response = await http.delete(
      Uri.parse('https://sddkakn.onrender.com/user1/delet3/$id'),
      headers:{
