...
class ppostc extends StatefulWidget {
  const ppostc({Key? key}) : super(key: key);

  @override
  State<ppostc> createState() => _ppostcState();
}

class _ppostcState extends State<ppostc> {
  void initState() {
  ...
  upload() async{
    ...
    var  res =await http.post(Uri.parse(  "https://sddkakn.onrender.com/user1/add3"),
