...
import 'package:katk/shib/post_segery.dart';
import 'package:katk/shib/secrren_details.dart';
...
import 'getdata.dart';
class shib extends StatefulWidget {
  const shib({Key? key}) : super(key: key);

  @override
  State<shib> createState() => _shibState();
}

class _shibState extends State<shib> {
  ...
  Future<List<PostSd>> deleteAlbum( id) async {
    final http.Response response = await http.delete(
      Uri.parse('https://sddkakn.onrender.com/user1/delet9/$id'),
      headers:{
