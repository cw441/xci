...
class  fvgsy extends StatefulWidget {
  String id;
  ...
  @override
  State<fvgsy> createState() => _fvgsyState(id,name,desc,conutry,prase,expar,sizeproduct,numberproduct,image);
}

class _fvgsyState extends State<fvgsy> {
  String id;
