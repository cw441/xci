...
import 'package:katk/snan/post_segery.dart';
import 'package:katk/snan/secrren_details.dart';

import 'getdata.dart';
class ssnan extends StatefulWidget {
  const ssnan({Key? key}) : super(key: key);

  @override
  State<ssnan> createState() => _ssnanState();
}

class _ssnanState extends State<ssnan> {
  ...
  Future<List<PostSd>> deleteAlbum( id) async {
    final http.Response response = await http.delete(
      Uri.parse('https://sddkakn.onrender.com/user1/delet5/$id'),
      headers:{
