...
class  screteww extends StatefulWidget {
  String id;
  ...
  @override
  State<screteww> createState() => _scretewwState(id,name,desc,conutry,prase,expar,sizeproduct,numberproduct,image);
}

class _scretewwState extends State<screteww> {
  String id;
                                  ...
                                  SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                                   Row(
                                    ...
                                    Container(
                                      ...
                                      child: coomwes(
                                          iad:id,
                                          apidata:'https://sddkakn.onrender.com/user1/comnetuserg5/${id}'
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: pcs(
                                          iad:id,
                                          apip:"https://sddkakn.onrender.com/user1/comnetuserp5"
                                      ),
                                    )
                                  ]
                       )
