...
class duof extends StatefulWidget {
  const duof({Key? key}) : super(key: key);

  @override
  State<duof> createState() => _duofState();
}

class _duofState extends State<duof> {
  void initState() {
  ...
  upload() async{
    ...
    var  res =await http.post(Uri.parse(  "https://sddkakn.onrender.com/userr/ads"),
