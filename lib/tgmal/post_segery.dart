...
class ssscz extends StatefulWidget {
  const ssscz({Key? key}) : super(key: key);

  @override
  State<ssscz> createState() => _sssczState();
}

class _sssczState extends State<ssscz> {
  void initState() {
  ...
  upload() async{
    ...
    var  res =await http.post(Uri.parse(  "https://sddkakn.onrender.com/user1/add7"),
