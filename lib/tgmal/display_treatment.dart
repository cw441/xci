...
import 'getdata.dart';
class tgmal extends StatefulWidget {
  const tgmal({Key? key}) : super(key: key);

  @override
  State<tgmal> createState() => _tgmalState();
}

class _tgmalState extends State<tgmal> {
  ...
  Future<List<PostSd>> deleteAlbum( id) async {
    final http.Response response = await http.delete(
      Uri.parse('https://sddkakn.onrender.com/user1/delet7/$id'),
      headers:{
