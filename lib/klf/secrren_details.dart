...
class  screeeen extends StatefulWidget {
  String id;
  ...
  @override
  State<screeeen> createState() => _screeeenState(id,name,desc,conutry,prase,expar,sizeproduct,numberproduct,image);
}

class _screeeenState extends State<screeeen> {
  String id;
  String name;
                                  ...
                                  SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                                   Row(
                                    ...
                                    Container(
                                      ...
                                      child: coomwes(
                                          iad:id,
                                          apidata:'https://sddkakn.onrender.com/user1/comnetuserg4/${id}'
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: pcs(
                                          iad:id,
                                          apip:"https://sddkakn.onrender.com/user1/comnetuserp4"
                                      ),
                                    )
                                  ]
                       )
