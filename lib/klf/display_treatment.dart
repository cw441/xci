...
import 'getdata.dart';
class klb extends StatefulWidget {
  const klb({Key? key}) : super(key: key);

  @override
  State<klb> createState() => _klbState();
}

class _klbState extends State<klb> {
  ...
  Future<List<PostSd>> deleteAlbum( id) async {
    final http.Response response = await http.delete(
      Uri.parse('https://sddkakn.onrender.com/user1/delet4/$id'),
      headers:{
