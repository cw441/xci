...
class  screeeenqq extends StatefulWidget {
  String id;
  ...
  @override
  State<screeeenqq> createState() => _screeeenqqState(id,name,desc,conutry,prase,expar,sizeproduct,numberproduct,image);
}

class _screeeenqqState extends State<screeeenqq> {
  String id;
  String name;
  String desc;
  String conutry;
                                  ...
                                  SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                                   Row(
                                    ...
                                    Container(
                                      ...
                                      child: coomwes(
                                          iad:id,
                                          apidata:'https://sddkakn.onrender.com/user1/comnetuserg6/${id}'
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: pcs(
                                          iad:id,
                                          apip:"https://sddkakn.onrender.com/user1/comnetuserp6"
                                      ),
                                    )
                                  ]
                       )
