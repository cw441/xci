...
class rtsf extends StatefulWidget {
  const rtsf({Key? key}) : super(key: key);

  @override
  State<rtsf> createState() => _rtsfState();
}

class _rtsfState extends State<rtsf> {
  void initState() {
  ...
  upload() async{
    ...
    var  res =await http.post(Uri.parse(  "https://sddkakn.onrender.com/user1/add6"),
