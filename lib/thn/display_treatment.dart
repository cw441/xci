...
import 'package:katk/thn/secrren_details.dart';

import '../snan/secrren_details.dart';
import 'getdata.dart';
class thn extends StatefulWidget {
  const thn({Key? key}) : super(key: key);

  @override
  State<thn> createState() => _thnState();
}

class _thnState extends State<thn> {
  ...
  Future<List<PostSd>> deleteAlbum( id) async {
    final http.Response response = await http.delete(
      Uri.parse('https://sddkakn.onrender.com/user1/delet6/$id'),
      headers:{
